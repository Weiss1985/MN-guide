...
COINDOWNLOADLINK1=https://github.com/WinoDev/Wino/releases/download/v1.0/winod
COINDOWNLOADLINK2=https://github.com/WinoDev/Wino/releases/download/v1.0/wino-cli
COINDOWNLOADLINK3=https://github.com/WinoDev/Wino/releases/download/v1.0/wino-tx
COINPORT=27781
COINRPCPORT=27782
COINDAEMON=winod
COINDAEMONCLI=wino-cli
COINDAEMONTX=wino-tx
COINCORE=.wino
COINCONFIG=wino.conf
...
echo -e "------------------------------------------------------------"
echo -e "|                                                          |"
echo -e "|        ${BOLD}---- Wino masternode installer ----${NONE}        |"
echo -e "|                                                          |"
echo -e "------------------------------------------------------------"

echo -e "${BOLD}"
read -p "This script will install a Wino masternode wallet on your VPS. Do you wish to continue? (y/n)?" response
echo -e "${NONE}"
